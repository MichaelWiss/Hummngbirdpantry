...
export const upsertProduct = async (partial: Partial<PantryItem> & {
  ...
  const item: PantryItem = {
    ...
    ...(partial.barcode ? { barcode: partial.barcode } : {}),
    quantity: partial.quantity,
    unit: partial.unit,
    purchaseDate: partial.purchaseDate || now,
    expirationDate: partial.expirationDate,
    ...(typeof partial.price === 'number' ? { price: partial.price } : {}),
    ...(typeof partial.pricePerUnit === 'number' ? { pricePerUnit: partial.pricePerUnit } : {}),
